...
%\newcommand{\summ}[2][ ]{\underset{#2}{\overset{#1}{\sum}}}
%\newcommand{\minn}[1]{\underset{#1}{\min}}
%\newcommand{\maxx}[1]{\underset{#1}{\max}}
...
% \foreach \n \in {1,...,6, 20, 21} {\input{que\n.tex}} 
% ВМЕСТО строки ниже
\foreach \n in {1,...,9,12,20,21} {\input{que\n.tex}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
